...
- `domain-architecture-v4.md` — canonical Domain Architecture V4 (`IAAS-DOM-ARCH-4`, FROZEN).
...
- `domain-requirements-v4.md` — V4 domain requirements (`DOM-018`..`DOM-022`).
...
- `domain-dependency-graph-v4.md` — V4 dependency delta for Extension Stack.
