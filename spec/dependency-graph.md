...
WORK-001 is VERIFIED. WORK-002 is VERIFIED. WORK-003 is VERIFIED. WORK-004 is VERIFIED. WORK-005 depends on WORK-004; that dependency is satisfied, so WORK-005 is eligible and has been released by the Architect.
...
`WORK-004` and `WORK-005` are governed by `IAAS-DOM-ARCH-2` while their Work Item governing authority remains `IAAS-GOV-ARCH-1`.
