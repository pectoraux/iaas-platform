...
WORK-001 is VERIFIED. WORK-002 is VERIFIED. WORK-003 is VERIFIED. WORK-004 is VERIFIED. WORK-005 is VERIFIED. WORK-006 is VERIFIED. WORK-007 depends on WORK-006; that dependency is satisfied, so WORK-007 is eligible and has been released by the Architect.
...
`WORK-004`, `WORK-005`, `WORK-006`, and `WORK-007` are governed by `IAAS-DOM-ARCH-2` while their Work Item governing authority remains `IAAS-GOV-ARCH-1`.
