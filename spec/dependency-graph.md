...
WORK-001 is VERIFIED. WORK-002 is VERIFIED. WORK-003 is VERIFIED. WORK-004 depends on WORK-003; that dependency is satisfied, so WORK-004 is eligible and has been released by the Architect.
...
`WORK-004` is governed by `IAAS-DOM-ARCH-2` while its Work Item governing authority remains `IAAS-GOV-ARCH-1`.
