...
describe('spec consistency validator — negative cases (WORK-001 Required Tests)', () => {
  ...
  test('fails when the dependency graph contains a cycle (SC-10)', () => {
    ...
    expectFailure(runValidator(specDir), 'SC-10', 'dependency cycle detected')
  })
})
