...
beforeAll(async () => {
  ...
  await assignAssetToNetwork(tenantId, assetId, networkId, 'frequency_response', '10', 'kW')
  await assignAssetToNetwork(tenantId, assetId, networkId, 'energy_capacity', '10', 'kWh')
